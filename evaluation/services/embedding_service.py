...
class TpqsConfig:
    ...
    def from_env(cls, env: dict | None = None) -> "TpqsConfig":
        ...
        return cls(
            ...
            use_perceptual=source.get("ITTE_USE_PERCEPTUAL", "true").lower() in {"1", "true", "yes", "on"},
            use_vgg_gram=source.get("ITTE_USE_VGG_GRAM", "true").lower() in {"1", "true", "yes", "on"},
        )
